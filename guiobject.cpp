...
GUIObject::GUIObject(ISceneNode *parent, std::vector<double> positionVector, std::vector<double> rotationMatrix,
...
/**
 * Calculates the euler angles from the rotation matrix and applies them to the
 * node.
 *
 * @see
